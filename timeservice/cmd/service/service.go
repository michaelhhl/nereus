...
import (
	...
	grpc "github.com/michaelhhl/nereus/timeservice/pkg/grpc"
...
var fs = flag.NewFlagSet("timeservice", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("timeservice", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterTimeserviceServer(baseServer, grpcServer)
